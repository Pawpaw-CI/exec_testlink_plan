...
def parserjson(jsondata):
    d = json.dumps(jsondata, sort_keys=True, indent=4)
    print(d)
...
parser.add_argument(
    "--idfile", help="save the test plan case ids filename",
    default="id.txt")

parser.add_argument(
    "--templejson", help="the template json file",
    default="temple.job")
